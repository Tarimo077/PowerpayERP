...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-powerpayerp-secret")
...
TEMPLATES = [{"BACKEND": "django.template.backends.django.DjangoTemplates", "DIRS": [BASE_DIR / "templates"], "APP_DIRS": True, "OPTIONS": {"context_processors": ["django.template.context_processors.request", "django.contrib.auth.context_processors.auth", "django.contrib.messages.context_processors.messages", "erp.context_processors.erp_context"]}}]
...
AUTHENTICATION_BACKENDS = ["erp.auth_backends.EmailBackend", "django.contrib.auth.backends.ModelBackend"]
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "PowerpayERP <noreply@powerpayerp.local>")
